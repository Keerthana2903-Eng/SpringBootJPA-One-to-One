...
import com.example.One_to_One.Repository.AddressRepository;
...
public class AddressController {
	...
	address2.setCity(address.getClass());
	}
	...
	public Page<Address> getPaginatedAndSorted(@PathVariable int pageNo,@PathVariable int
	pageSize ,@PathVariable String field,@PathVariable String direction) {
